...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Process sequences using ESM-C model.')
    parser.add_argument('--fasta', type=str, help='Input FASTA file')
    parser.add_argument('--model_choice', type=str, help='Choice of ESMC model. Options: [esmc_600m, esmc_300m] Default: esmc_600m', default = 'esmc_600m')
